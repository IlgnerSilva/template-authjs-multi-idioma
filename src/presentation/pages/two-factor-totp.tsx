import { FormLoginTOTP } from '@/presentation/components/shared/form-login-totp.shared.component';
import { SwitcherLocale } from '@/presentation/components/shared/switcher-locale';
import {
	Card,
	CardContent,
	CardHeader,
